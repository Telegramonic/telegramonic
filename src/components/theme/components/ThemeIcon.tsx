...
const IconSystem = (props: React.SVGProps<SVGSVGElement>) => (
...
const ICON_MAP: Record<ThemeOption, React.ReactNode> = {
  system: <IconSystem />,
  light:  <IconDay />,
  dark:   <IconNight />,
};
...
const ThemeSelector = () => {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        style={{ color: 'var(--chakra-colors-fg-muted)', lineHeight: 0, flexShrink: 0 }}
      >
        {ICON_MAP[current]}
      </span>
      ...
      <svg
        ...
        width="9"
        height="9"
        style={{ color: 'var(--chakra-colors-fg-muted)', pointerEvents: 'none', flexShrink: 0, marginLeft: '-10px' }}
        aria-hidden="true"
      >
